...
<body>
    ...
    <!-- SIDEBAR -->
    <div class="sidebar">
        <h4 class="text-white text-center mb-4">Mi Gimnasio</h4>
...
<div class="card shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
            ...
            <span class="badge bg-primary">En 2 días</span>
        </div>
        ...
        <div class="d-flex justify-content-between border-bottom pb-2 mb-2">
            ...
            <span class="badge bg-primary">En 3 días</span>
        </div>
        ...
        <div class="d-flex justify-content-between">
            ...
            <span class="badge bg-primary">En 5 días</span>
        </div>
